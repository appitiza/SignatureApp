...
public class SvgGenerator {
    ...
    private SvgPathGenerator mCurrentPathBuilder = null;
    ...
    public SvgGenerator append(final BezierPath curve, final float strokeWidth) {
    ...
    private void startNewPath(Integer roundedStrokeWidth, SvgPoint curveStartSvgPoint) {
        mCurrentPathBuilder = new SvgPathGenerator(curveStartSvgPoint, roundedStrokeWidth);
    }
