...
public class SvgPathGenerator {
    ...
    public SvgPathGenerator(final SvgPoint startPoint, final Integer strokeWidth) {
    ...
    public SvgPathGenerator append(final SvgPoint controlPoint1, final SvgPoint controlPoint2, final SvgPoint endPoint) {
