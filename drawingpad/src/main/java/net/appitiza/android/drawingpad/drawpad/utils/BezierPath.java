...
public class BezierPath {
    ...
    public Weights startPoint;
    public Weights control1;
    public Weights control2;
    public Weights endPoint;

    public BezierPath set(Weights startPoint, Weights control1,
                          Weights control2, Weights endPoint) {
